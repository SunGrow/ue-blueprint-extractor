...
export function registerStaticDocResources(server: Pick<McpServer, 'resource'>): void {
  ...
  registerStaticTextResource(
    ...
    [
      ...
      '- WidgetBlueprint: execute_widget_recipe, create_menu_screen, apply_widget_patch, create_widget_blueprint, replace_widget_tree, patch_widget, insert_widget_child, remove_widget, move_widget, wrap_widget, replace_widget_class, batch_widget_operations, apply_widget_diff, and compile_widget.',
      ...
      '- patch_widget supports direct widget_name or widget_path patches for one widget.',
      '- Prefer execute_widget_recipe, create_menu_screen, apply_widget_patch, apply_widget_diff, or operation-specific widget tools such as patch_widget, patch_widget_class_defaults, insert_widget_child, remove_widget, move_widget, wrap_widget, replace_widget_class, and batch_widget_operations.',
